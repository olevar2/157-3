"""
SoldiersSignal Indicator

SoldiersSignal candlestick/chart pattern indicator for technical analysis.
...
class SoldiersSignalIndicator(StandardIndicatorInterface):
    """
    SoldiersSignal Indicator

    Pattern recognition indicator for soldierssignal patterns.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize SoldiersSignal indicator
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.Series:
        """
        calculate SoldiersSignal pattern signals
    ...
    def get_metadata(self) -> Dict[str, Any]:
        """Return SoldiersSignal metadata as dictionary for compatibility"""
        return {
            "name": "SoldiersSignal",
            "category": self.CATEGORY,
            "description": "SoldiersSignal pattern recognition indicator",
    ...
    def _get_required_columns(self) -> List[str]:
        """SoldiersSignal requires OHLC data"""
...
def get_soldierssignal_indicator(**params) -> SoldiersSignalIndicator:
    """
    Factory function to create SoldiersSignal indicator
    
    Args:
        **params: Indicator parameters
        
    Returns:
        SoldiersSignalIndicator: Configured indicator instance
    """
    return SoldiersSignalIndicator(**params)


# Export for registry discovery
__all__ = ['SoldiersSignalIndicator', 'get_soldierssignal_indicator']
