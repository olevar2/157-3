...
VolumeDeltaSignal volume analysis indicator for institutional flow detection and volume momentum analysis.
...
class VolumeDeltaSignal(StandardIndicatorInterface):
    """VolumeDeltaSignal for volume analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'volume_delta_signal': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"volume_delta_signal": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="VolumeDeltaSignal", category=self.CATEGORY,
            description="VolumeDeltaSignal - Volume analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "VolumeDeltaSignal", "category": self.CATEGORY, 
