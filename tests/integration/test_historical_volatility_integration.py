"""
Integration tests for historical_volatility
...
class TestHistoricalvolatilityIntegration(unittest.TestCase):
    """Integration test suite for historical_volatility"""
