...
MarketMicrostructureSignal volume analysis indicator for institutional flow detection and volume momentum analysis.
...
class MarketMicrostructureSignal(StandardIndicatorInterface):
    """MarketMicrostructureSignal for volume analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'market_microstructure_signal': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"market_microstructure_signal": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="MarketMicrostructureSignal", category=self.CATEGORY,
            description="MarketMicrostructureSignal - Volume analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "MarketMicrostructureSignal", "category": self.CATEGORY, 
