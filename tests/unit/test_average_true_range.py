"""
Unit tests for average_true_range
...
class TestAveragetruerange(unittest.TestCase):
    ...
    def test_averagetruerange_initialization(self):
        """Test AverageTrueRange class initialization"""
        # TODO: Implement AverageTrueRange initialization test
        self.skipTest("Test not implemented yet")
    
    def test_averagetruerange_methods(self):
        """Test AverageTrueRange class methods"""
        # TODO: Implement AverageTrueRange methods test
        self.skipTest("Test not implemented yet")
