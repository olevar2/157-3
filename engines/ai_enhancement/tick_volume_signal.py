...
TickVolumeSignal volume analysis indicator for institutional flow detection and volume momentum analysis.
...
class TickVolumeSignal(StandardIndicatorInterface):
    """TickVolumeSignal for volume analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'tick_volume_signal': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"tick_volume_signal": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="TickVolumeSignal", category=self.CATEGORY,
            description="TickVolumeSignal - Volume analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "TickVolumeSignal", "category": self.CATEGORY, 
