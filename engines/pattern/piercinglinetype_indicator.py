"""
PiercingLineType Indicator

PiercingLineType candlestick/chart pattern indicator for technical analysis.
...
class PiercingLineTypeIndicator(StandardIndicatorInterface):
    """
    PiercingLineType Indicator

    Pattern recognition indicator for piercinglinetype patterns.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize PiercingLineType indicator
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.Series:
        """
        calculate PiercingLineType pattern signals
    ...
    def get_metadata(self) -> Dict[str, Any]:
        """Return PiercingLineType metadata as dictionary for compatibility"""
        return {
            "name": "PiercingLineType",
            "category": self.CATEGORY,
            "description": "PiercingLineType pattern recognition indicator",
    ...
    def _get_required_columns(self) -> List[str]:
        """PiercingLineType requires OHLC data"""
...
def get_piercinglinetype_indicator(**params) -> PiercingLineTypeIndicator:
    """
    Factory function to create PiercingLineType indicator
    
    Args:
        **params: Indicator parameters
        
    Returns:
        PiercingLineTypeIndicator: Configured indicator instance
    """
    return PiercingLineTypeIndicator(**params)


# Export for registry discovery
__all__ = ['PiercingLineTypeIndicator', 'get_piercinglinetype_indicator']
