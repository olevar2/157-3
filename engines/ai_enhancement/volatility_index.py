...
VolatilityIndex volatility analysis indicator for risk measurement and volatility regime detection.
...
class VolatilityIndex(StandardIndicatorInterface):
    """VolatilityIndex for volatility analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'volatility_index': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"volatility_index": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="VolatilityIndex", category=self.CATEGORY,
            description="VolatilityIndex - Volatility analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "VolatilityIndex", "category": self.CATEGORY, 
