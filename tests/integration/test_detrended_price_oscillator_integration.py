"""
Integration tests for detrended_price_oscillator
...
class TestDetrendedpriceoscillatorIntegration(unittest.TestCase):
    """Integration test suite for detrended_price_oscillator"""
