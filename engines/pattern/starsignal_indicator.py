"""
StarSignal Indicator

StarSignal candlestick/chart pattern indicator for technical analysis.
...
class StarSignalIndicator(StandardIndicatorInterface):
    """
    StarSignal Indicator

    Pattern recognition indicator for starsignal patterns.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize StarSignal indicator
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.Series:
        """
        calculate StarSignal pattern signals
    ...
    def get_metadata(self) -> Dict[str, Any]:
        """Return StarSignal metadata as dictionary for compatibility"""
        return {
            "name": "StarSignal",
            "category": self.CATEGORY,
            "description": "StarSignal pattern recognition indicator",
...
def get_starsignal_indicator(**params) -> StarSignalIndicator:
    """
    Factory function to create StarSignal indicator
    
    Args:
        **params: Indicator parameters
        
    Returns:
        StarSignalIndicator: Configured indicator instance
    """
    return StarSignalIndicator(**params)


# Export for registry discovery
__all__ = ['StarSignalIndicator', 'get_starsignal_indicator']
