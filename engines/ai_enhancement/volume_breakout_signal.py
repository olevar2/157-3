...
VolumeBreakoutSignal volume analysis indicator for institutional flow detection and volume momentum analysis.
...
class VolumeBreakoutSignal(StandardIndicatorInterface):
    """VolumeBreakoutSignal for volume analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'volume_breakout_signal': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"volume_breakout_signal": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="VolumeBreakoutSignal", category=self.CATEGORY,
            description="VolumeBreakoutSignal - Volume analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "VolumeBreakoutSignal", "category": self.CATEGORY, 
