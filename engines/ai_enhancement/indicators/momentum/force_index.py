"""
ForceIndex - Platform3 Indicator
Forceindex analysis implementation
"""
...
class ForceIndexResult:
    """Results from forceindex analysis"""
    value: float
...
class ForceIndex(IndicatorBase):
    """
    Forceindex indicator implementation.
    """
    ...
    def _generate_signal(self, result: ForceIndexResult) -> str:
