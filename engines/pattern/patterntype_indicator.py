...
PatternType candlestick/chart pattern indicator for technical analysis.
...
class PatternTypeIndicator(StandardIndicatorInterface):
    """
    PatternType Indicator

    Pattern recognition indicator for patterntype patterns.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize PatternType indicator
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.Series:
        """
        calculate PatternType pattern signals
    ...
    def get_metadata(self) -> Dict[str, Any]:
        """Return PatternType metadata as dictionary for compatibility"""
        return {
            "name": "PatternType",
            "category": self.CATEGORY,
            "description": "PatternType pattern recognition indicator",
    ...
    def _get_required_columns(self) -> List[str]:
        """PatternType requires OHLC data"""
...
def get_patterntype_indicator(**params) -> PatternTypeIndicator:
    """
    Factory function to create PatternType indicator
    
    Args:
        **params: Indicator parameters
        
    Returns:
        PatternTypeIndicator: Configured indicator instance
    """
    return PatternTypeIndicator(**params)


# Export for registry discovery
__all__ = ['PatternTypeIndicator', 'get_patterntype_indicator']
