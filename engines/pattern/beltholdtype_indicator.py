"""
BeltHoldType Indicator

BeltHoldType candlestick/chart pattern indicator for technical analysis.
...
class BeltHoldTypeIndicator(StandardIndicatorInterface):
    ...
    Pattern recognition indicator for beltholdtype patterns.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize BeltHoldType indicator
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.Series:
        """
        Calculate BeltHoldType pattern signals
    ...
    def get_metadata(self) -> Dict[str, Any]:
        """Return BeltHoldType metadata as dictionary for compatibility"""
        return {
            "name": "BeltHoldType",
            "category": self.CATEGORY,
            "description": "BeltHoldType pattern recognition indicator",
    ...
    def _get_required_columns(self) -> List[str]:
        """BeltHoldType requires OHLC data"""
...
def get_beltholdtype_indicator(**params) -> BeltHoldTypeIndicator:
    """
    Factory function to create BeltHoldType indicator
...
__all__ = ['BeltHoldTypeIndicator', 'get_beltholdtype_indicator']
