"""
Integration tests for indicator_data_organizer
...
class TestIndicatordataorganizerIntegration(unittest.TestCase):
    """Integration test suite for indicator_data_organizer"""
