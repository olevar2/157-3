"""
Integration tests for standard_deviation_channels
...
class TestStandarddeviationchannelsIntegration(unittest.TestCase):
    """Integration test suite for standard_deviation_channels"""
