"""
OnBalanceVolume - Platform3 Financial Indicator
...
class OnBalanceVolume(StandardIndicatorInterface):
    """
    OnBalanceVolume - Platform3 Implementation
...
if __name__ == "__main__":
    ...
    print(f"OnBalanceVolume test result: {result}")
