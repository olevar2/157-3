"""
DarkCloudType Indicator

DarkCloudType candlestick/chart pattern indicator for technical analysis.
...
class DarkCloudTypeIndicator(StandardIndicatorInterface):
    """
    DarkCloudType Indicator

    Pattern recognition indicator for darkcloudtype patterns.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize DarkCloudType indicator
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.Series:
        """
        calculate DarkCloudType pattern signals
    ...
    def get_metadata(self) -> Dict[str, Any]:
        """Return DarkCloudType metadata as dictionary for compatibility"""
        return {
            "name": "DarkCloudType",
            "category": self.CATEGORY,
            "description": "DarkCloudType pattern recognition indicator",
    ...
    def _get_required_columns(self) -> List[str]:
        """DarkCloudType requires OHLC data"""
...
def get_darkcloudtype_indicator(**params) -> DarkCloudTypeIndicator:
    """
    Factory function to create DarkCloudType indicator
    
    Args:
        **params: Indicator parameters
        
    Returns:
        DarkCloudTypeIndicator: Configured indicator instance
    """
    return DarkCloudTypeIndicator(**params)


# Export for registry discovery
__all__ = ['DarkCloudTypeIndicator', 'get_darkcloudtype_indicator']
