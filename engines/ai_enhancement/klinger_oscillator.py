...
KlingerOscillator volume analysis indicator for institutional flow detection and volume momentum analysis.
...
class KlingerOscillator(StandardIndicatorInterface):
    """KlingerOscillator for volume analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'klinger_oscillator': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"klinger_oscillator": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="KlingerOscillator", category=self.CATEGORY,
            description="KlingerOscillator - Volume analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "KlingerOscillator", "category": self.CATEGORY, 
