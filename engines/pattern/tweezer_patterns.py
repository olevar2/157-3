...
class TweezerPatterns(IndicatorBase):
    ...
    def _create_tweezer_result(self, candle1: CandleData, candle2: CandleData, 
                             candles: List[CandleData], position: int, is_top: bool):
        ...
        strength = self._calculate_pattern_strength(candle1, candle2, candles, position, is_top)
        ...
        volume_confirmation = self._check_volume_confirmation(candle2, candles, position)
    ...
    def _calculate_level_tolerance(self, candle1: CandleData, candle2: CandleData, is_top: bool) -> float:
    ...
    def _calculate_pattern_strength(self, candle1: CandleData, candle2: CandleData, 
                                  candles: List[CandleData], position: int, is_top: bool) -> float:
    ...
    def _calculate_confidence(self, candle1: CandleData, candle2: CandleData, is_top: bool) -> float:
    ...
    def _calculate_target_levels(self, candle1: CandleData, candle2: CandleData, is_top: bool) -> List[float]:
    ...
    def _calculate_stop_loss(self, candle1: CandleData, candle2: CandleData, is_top: bool) -> float:
        """Calculate suggested stop loss level"""
        if is_top:
            # Stop above the tweezer top
            return max(candle1.high, candle2.high) + (abs(candle2.close - candle2.open) * 0.2)
        else:
            # Stop below the tweezer bottom
            return min(candle1.low, candle2.low) - (abs(candle2.close - candle2.open) * 0.2)
