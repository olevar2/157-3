"""
KickingSignal Indicator

KickingSignal candlestick/chart pattern indicator for technical analysis.
...
class KickingSignalIndicator(StandardIndicatorInterface):
    """
    KickingSignal Indicator

    Pattern recognition indicator for kickingsignal patterns.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize KickingSignal indicator
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.Series:
        """
        calculate KickingSignal pattern signals
    ...
    def get_metadata(self) -> Dict[str, Any]:
        """Return KickingSignal metadata as dictionary for compatibility"""
        return {
            "name": "KickingSignal",
            "category": self.CATEGORY,
            "description": "KickingSignal pattern recognition indicator",
    ...
    def _get_required_columns(self) -> List[str]:
        """KickingSignal requires OHLC data"""
...
def get_kickingsignal_indicator(**params) -> KickingSignalIndicator:
    """
    Factory function to create KickingSignal indicator
    
    Args:
        **params: Indicator parameters
        
    Returns:
        KickingSignalIndicator: Configured indicator instance
    """
    return KickingSignalIndicator(**params)


# Export for registry discovery
__all__ = ['KickingSignalIndicator', 'get_kickingsignal_indicator']
