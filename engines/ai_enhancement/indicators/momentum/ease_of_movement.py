"""
EaseOfMovement - Platform3 Indicator
Easeofmovement analysis implementation
"""
...
class EaseOfMovementResult:
    """Results from easeofmovement analysis"""
    value: float
...
class EaseOfMovement(IndicatorBase):
    """
    Easeofmovement indicator implementation.
    """
    
    def __init__(self, period: int = 14):
        super().__init__()
        self.period = period
        self.name = "EaseOfMovement"
        
    def calculate(self, data: pd.DataFrame) -> Dict[str, Any]:
        """Calculate easeofmovement value"""
    ...
    def _generate_signal(self, result: EaseOfMovementResult) -> str:
