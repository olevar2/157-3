"""
AverageTrueRange - Platform3 Financial Indicator
...
class AverageTrueRange(StandardIndicatorInterface):
    """
    AverageTrueRange - Platform3 Implementation
    ...
    def __init__(self, period: int = 20):
        """Initialize AverageTrueRange."""
        super().__init__()
        self.period = period
        self.name = "AverageTrueRange"
        self.version = "1.0.0"
...
if __name__ == "__main__":
    ...
    print(f"AverageTrueRange test result: {result}")
