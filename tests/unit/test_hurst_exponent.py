...
class TestHurstexponent(unittest.TestCase):
    ...
    def test_hurstexponent_initialization(self):
        """Test HurstExponent class initialization"""
        # TODO: Implement HurstExponent initialization test
        self.skipTest("Test not implemented yet")
    
    def test_hurstexponent_methods(self):
        """Test HurstExponent class methods"""
        # TODO: Implement HurstExponent methods test
        self.skipTest("Test not implemented yet")
