...
InstitutionalFlowSignal volume analysis indicator for institutional flow detection and volume momentum analysis.
...
class InstitutionalFlowSignal(StandardIndicatorInterface):
    """InstitutionalFlowSignal for volume analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'institutional_flow_signal': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"institutional_flow_signal": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="InstitutionalFlowSignal", category=self.CATEGORY,
            description="InstitutionalFlowSignal - Volume analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "InstitutionalFlowSignal", "category": self.CATEGORY, 
