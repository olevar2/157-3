...
EaseOfMovement volume analysis indicator for institutional flow detection and volume momentum analysis.
...
class EaseOfMovement(StandardIndicatorInterface):
    """EaseOfMovement for volume analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'ease_of_movement': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"ease_of_movement": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="EaseOfMovement", category=self.CATEGORY,
            description="EaseOfMovement - Volume analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "EaseOfMovement", "category": self.CATEGORY, 
