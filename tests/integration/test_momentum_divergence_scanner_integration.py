"""
Integration tests for momentum_divergence_scanner
...
class TestMomentumdivergencescannerIntegration(unittest.TestCase):
    """Integration test suite for momentum_divergence_scanner"""
