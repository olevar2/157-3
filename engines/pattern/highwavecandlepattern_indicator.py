"""
HighWaveCandlePattern Indicator

HighWaveCandlePattern candlestick/chart pattern indicator for technical analysis.
...
class HighWaveCandlePatternIndicator(StandardIndicatorInterface):
    """
    HighWaveCandlePattern Indicator

    Pattern recognition indicator for highwavecandlepattern patterns.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize HighWaveCandlePattern indicator
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.Series:
        """
        calculate HighWaveCandlePattern pattern signals
    ...
    def get_metadata(self) -> Dict[str, Any]:
        """Return HighWaveCandlePattern metadata as dictionary for compatibility"""
        return {
            "name": "HighWaveCandlePattern",
            "category": self.CATEGORY,
            "description": "HighWaveCandlePattern pattern recognition indicator",
    ...
    def _get_required_columns(self) -> List[str]:
        """HighWaveCandlePattern requires OHLC data"""
...
def get_highwavecandlepattern_indicator(**params) -> HighWaveCandlePatternIndicator:
    """
    Factory function to create HighWaveCandlePattern indicator
    
    Args:
        **params: Indicator parameters
        
    Returns:
        HighWaveCandlePatternIndicator: Configured indicator instance
    """
    return HighWaveCandlePatternIndicator(**params)


# Export for registry discovery
__all__ = ['HighWaveCandlePatternIndicator', 'get_highwavecandlepattern_indicator']
