"""
Integration tests for hidden_divergence_detector
...
class TestHiddendivergencedetectorIntegration(unittest.TestCase):
    """Integration test suite for hidden_divergence_detector"""
