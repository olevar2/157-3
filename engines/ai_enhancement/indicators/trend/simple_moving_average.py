"""
SimpleMovingAverage - Platform3 Financial Indicator
...
class SimpleMovingAverage(StandardIndicatorInterface):
    """
    SimpleMovingAverage - Platform3 Implementation
...
if __name__ == "__main__":
    ...
    print(f"SimpleMovingAverage test result: {result}")
