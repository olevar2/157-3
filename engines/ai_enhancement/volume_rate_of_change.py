...
VolumeRateOfChange volume analysis indicator for institutional flow detection and volume momentum analysis.
...
class VolumeRateOfChange(StandardIndicatorInterface):
    """VolumeRateOfChange for volume analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'volume_rate_of_change': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"volume_rate_of_change": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="VolumeRateOfChange", category=self.CATEGORY,
            description="VolumeRateOfChange - Volume analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "VolumeRateOfChange", "category": self.CATEGORY, 
                "parameters": self.parameters, "version": self.VERSION}

def get_indicator_class():
    return VolumeRateOfChange
