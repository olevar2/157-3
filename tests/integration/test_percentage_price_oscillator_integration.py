"""
Integration tests for percentage_price_oscillator
...
class TestPercentagepriceoscillatorIntegration(unittest.TestCase):
    """Integration test suite for percentage_price_oscillator"""
