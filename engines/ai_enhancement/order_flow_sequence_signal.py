...
OrderFlowSequenceSignal volume analysis indicator for institutional flow detection and volume momentum analysis.
...
class OrderFlowSequenceSignal(StandardIndicatorInterface):
    """OrderFlowSequenceSignal for volume analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'order_flow_sequence_signal': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"order_flow_sequence_signal": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="OrderFlowSequenceSignal", category=self.CATEGORY,
            description="OrderFlowSequenceSignal - Volume analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "OrderFlowSequenceSignal", "category": self.CATEGORY, 
