"""
WaveType - Platform3 Indicator
Wavetype analysis implementation
"""
...
@dataclass
class WaveTypeResult:
    """Results from wavetype analysis"""
    value: float
...
class WaveType(IndicatorBase):
    """
    Wavetype indicator implementation.
    """
    ...
    def _generate_signal(self, result: WaveTypeResult) -> str:
