...
try:
    from engines.volume.vwap import *
...
class TestVwap(unittest.TestCase):
    ...
    def test_vwap_initialization(self):
        """Test Vwap class initialization"""
        # TODO: Implement Vwap initialization test
        self.skipTest("Test not implemented yet")
    
    def test_vwap_methods(self):
        """Test Vwap class methods"""
        # TODO: Implement Vwap methods test
        self.skipTest("Test not implemented yet")
