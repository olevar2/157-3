...
class DojiSignal(Enum):
    ...
    NEUTRAL = "neutral"# Create a completely independent dataclass without extending IndicatorResult
@dataclass
        ...
        try:
            ...
            result = DojiRecognitionResult(
                ...
                metadata={
                    ...
                    'calculation_time_ms': 0  # Placeholder for any timing calculation
                }
            )            
