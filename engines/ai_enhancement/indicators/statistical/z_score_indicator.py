"""
ZScoreIndicator - Platform3 Indicator
Zscore analysis implementation
"""
...
@dataclass
class ZScoreIndicatorResult:
    """Results from zscoreindicator analysis"""
    value: float
...
class ZScoreIndicator(IndicatorBase):
    """
    Zscore indicator implementation.
    """
    
    def __init__(self, period: int = 14):
        super().__init__()
        self.period = period
        self.name = "ZScoreIndicator"
        
    def calculate(self, data: pd.DataFrame) -> Dict[str, Any]:
        """Calculate zscoreindicator value"""
    ...
    def _generate_signal(self, result: ZScoreIndicatorResult) -> str:
