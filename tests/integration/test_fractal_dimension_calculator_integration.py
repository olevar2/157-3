"""
Integration tests for fractal_dimension_calculator
...
class TestFractaldimensioncalculatorIntegration(unittest.TestCase):
    """Integration test suite for fractal_dimension_calculator"""
