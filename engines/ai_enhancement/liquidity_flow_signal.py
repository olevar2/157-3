...
LiquidityFlowSignal volume analysis indicator for institutional flow detection and volume momentum analysis.
...
class LiquidityFlowSignal(StandardIndicatorInterface):
    """LiquidityFlowSignal for volume analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'liquidity_flow_signal': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"liquidity_flow_signal": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="LiquidityFlowSignal", category=self.CATEGORY,
            description="LiquidityFlowSignal - Volume analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "LiquidityFlowSignal", "category": self.CATEGORY, 
