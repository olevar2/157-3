"""
Integration tests for linear_regression_channels
...
class TestLinearregressionchannelsIntegration(unittest.TestCase):
    """Integration test suite for linear_regression_channels"""
