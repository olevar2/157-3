"""
ThreeOutsideSignal Indicator

ThreeOutsideSignal candlestick/chart pattern indicator for technical analysis.
...
class ThreeOutsideSignalIndicator(StandardIndicatorInterface):
    """
    ThreeOutsideSignal Indicator

    Pattern recognition indicator for threeoutsidesignal patterns.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize ThreeOutsideSignal indicator
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.Series:
        """
        calculate ThreeOutsideSignal pattern signals
    ...
    def get_metadata(self) -> Dict[str, Any]:
        """Return ThreeOutsideSignal metadata as dictionary for compatibility"""
        return {
            "name": "ThreeOutsideSignal",
            "category": self.CATEGORY,
            "description": "ThreeOutsideSignal pattern recognition indicator",
    ...
    def _get_required_columns(self) -> List[str]:
        """ThreeOutsideSignal requires OHLC data"""
...
def get_threeoutsidesignal_indicator(**params) -> ThreeOutsideSignalIndicator:
    """
    Factory function to create ThreeOutsideSignal indicator
    
    Args:
        **params: Indicator parameters
        
    Returns:
        ThreeOutsideSignalIndicator: Configured indicator instance
    """
    return ThreeOutsideSignalIndicator(**params)


# Export for registry discovery
__all__ = ['ThreeOutsideSignalIndicator', 'get_threeoutsidesignal_indicator']
