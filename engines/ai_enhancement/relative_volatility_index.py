...
RelativeVolatilityIndex volatility analysis indicator for risk measurement and volatility regime detection.
...
class RelativeVolatilityIndex(StandardIndicatorInterface):
    """RelativeVolatilityIndex for volatility analysis"""
    ...
    def calculate(self, data: Union[pd.DataFrame, pd.Series]) -> pd.DataFrame:
        ...
        result = pd.DataFrame({
            'relative_volatility_index': result_value,
            'signals': signals
        }, index=index)
        
        self._last_calculation = {"relative_volatility_index": result_value, "signals": signals}
        return result
    ...
    def get_metadata(self) -> IndicatorMetadata:
        return IndicatorMetadata(
            name="RelativeVolatilityIndex", category=self.CATEGORY,
            description="RelativeVolatilityIndex - Volatility analysis indicator",
    ...
    def get_config(self) -> Dict[str, Any]:
        return {"name": "RelativeVolatilityIndex", "category": self.CATEGORY, 
