"""
ExponentialMovingAverage - Platform3 Financial Indicator
...
class ExponentialMovingAverage(StandardIndicatorInterface):
    """
    ExponentialMovingAverage - Platform3 Implementation
    ...
    def __init__(self, period: int = 20):
        ...
        super().__init__()
        self.period = period
        self.name = "ExponentialMovingAverage"
        self.version = "1.0.0"
    ...
    def calculate(self, data: Union[np.ndarray, pd.DataFrame]) -> Dict[str, Any]:
        """Calculate ExponentialMovingAverage."""
        try:
...
if __name__ == "__main__":
    ...
    print(f"ExponentialMovingAverage test result: {result}")
